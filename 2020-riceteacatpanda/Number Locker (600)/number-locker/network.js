...
export function fetch(e, t) {
  return new Promise(function(r, o) {
    ...
    (n.onload = function() {
      var e = { status: n.status, statusText: n.statusText, headers: parseHeaders(n.getAllResponseHeaders() || "") };
      ...
      "include" === s.credentials ? (n.withCredentials = !0) : "omit" === s.credentials && (n.withCredentials = !1),
